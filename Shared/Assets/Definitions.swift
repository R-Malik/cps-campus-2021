...
let defaultQuickLinks = [QuickLink(name: "Common Classroom", id: "", icon: "rectangle.inset.filled.and.person.filled", visible: true), QuickLink(name: "Radar", id: "", icon: "newspaper.fill", visible: false), QuickLink(name: "Library", id: "", icon: "books.vertical.fill", visible: false), QuickLink(name: "Submit Feedback", id: "", icon: "exclamationmark.bubble.fill", visible: true)]
...
let palette12 = Palette(name: "Rainwing Tears", colorsHex: ["FD335B","FF786A","78D3F8","0C75E4","FDA90F","F80C97","D005D4","7244F5","40B7FF"], campusID: "appdev", creator: "Rahim Malik")
