        ...
        VStack {
            ...
            Button(action: {
                ...
                if bakeSale {
                    ...
                    Contact the <a href="mailto:">Innovation Team</a> for assistance</p><br />
                    """
                    ...
                    Sent from CPS Campus<br />
                    Reply all to this email to contact the club<br />
                    Contact the <a href="mailto:">Innovation Team</a> for assistance</p>
                    """
            ...
            .alert(isPresented: $showAlert) {
                Alert(title: Text(bakeSale ? "Bake Sale Requested" : "Meeting Requested"), message: Text("Please reach out to \(bakeSale ? "" : "") if you have any questions or want to reschedule your request."), dismissButton: .default(Text("OK")))
            }
    }
}
